...
public:
	enum CHIP_ID {
		...
		CHIP_ID_NUMBER_8,
		CHIP_ID_NUMBER_9,
		CHIP_ID_NUMBER_RED_0,
		CHIP_ID_NUMBER_RED_1,
		CHIP_ID_NUMBER_RED_2,
		CHIP_ID_NUMBER_RED_3,
		CHIP_ID_NUMBER_RED_4,
		CHIP_ID_NUMBER_RED_5,
		CHIP_ID_NUMBER_RED_6,
		CHIP_ID_NUMBER_RED_7,
		CHIP_ID_NUMBER_RED_8,
		CHIP_ID_NUMBER_RED_9,
		CHIP_ID_MAX
	};
private:
	enum GRAPH_ID {
